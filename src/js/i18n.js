const I18n = (() => {
  ...
  const T = {
    en: {
      ...
      index: {
        nl_ph_email:'your@email.com',
        form_honeypot:'Please leave this field empty',
        t1_role:'Google Local Guide · Children\'s birthday',
        t2_role:'Mum · Easter event',
        t3_role:'Mum · 3rd birthday party',
        t4_role:'Bride · Hen party',
        t5_role:'Family celebration',
        t6_role:'Organiser · Children\'s party',
        t1_text:'„We are more than delighted! Isa is such a warm person and our little one was over the moon with the wonderful unicorn she conjured up. She always had a smile on her face and responds beautifully to what the children want. Any time again!',
        t2_text:'„Isa did the face painting for us at Easter and the children were blown away! The rainbow unicorn was beautiful, and the little one got a dragon he proudly showed off. We will definitely book her again for the next celebration!',
        t3_text:'„Isa did the face painting for my daughter\'s third birthday. With her wonderful designs she puts a smile on every child\'s face. She is also very loving with the children, thoroughly likeable and always fully committed and in the best of moods. I warmly recommend her.',
        t4_text:'„I was very taken with Isa\'s work at my hen party. Her beautiful make-up made the celebration something truly special. Communication with her was so good that I spontaneously left her additional creative responsibility. Absolutely recommended!',
        t5_text:'„Isa was wonderfully warm and the children were thrilled. The face painting looked really lovely and held up well. Everything ran smoothly and relaxed. We would book her again any time!',
        t6_text:'„Isa made so many children happy at our children\'s party! Despite the big rush she stayed calm and composed. She has a wonderful rapport with children and responds to each one individually. And she still works quickly — everyone got their turn.',
      ...
      kinderschminken: {
        ...
        cta_label:'Ready?',
        cta_title:'Face painting for your next event',
        cta_text:'Your date may still be free — send a no-obligation enquiry, reply within 24 hours.',
        cta_btn:'Enquire now',
      ...
      hochzeiten: {
        ...
        mb1_text:'Full equipment, vegan professional paints and individual design advice are included in the price. For larger weddings, additional support can be arranged on request.',
        mb2_title:'Free first meeting',
        mb2_text:'Can\'t quite picture it yet? No problem at all. Just get in touch and I will show you all the options and variations. You are also welcome to arrange a no-obligation appointment and drop by for a free first meeting and trial painting. I look forward to meeting you!',
        faq_label:'Frequently asked questions',
        faq_title:'Face art at your wedding — your questions',
        cta_label:'Ready?',
        cta_title:'Face art for your wedding',
        cta_text:'Your date may still be free — send a no-obligation enquiry.',
        cta_btn:'Enquire now',
      ...
      unternehmen: {
        ...
        crosslink_kinderschminken:'Face painting →'},
      about: {
        cta_label:'Your next event',
        cta_title:'Let\'s create something special together',
        cta_text:'I look forward to your message — and even more to your event!',
        cta_btn:'Enquire now',
    ...
    fr: {
      ...
      index: {
        nl_ph_email:'votre@email.ch',
        form_honeypot:'Merci de laisser ce champ vide',
        t1_role:'Google Local Guide · Anniversaire d\'enfant',
        t2_role:'Maman · Événement de Pâques',
        t3_role:'Maman · 3e anniversaire',
        t4_role:'Mariée · Enterrement de vie de jeune fille',
        t5_role:'Fête de famille',
        t6_role:'Organisatrice · Fête pour enfants',
        t1_text:'« Nous sommes plus qu\'enthousiastes ! Isa est une personne très chaleureuse et notre petite était ravie de la magnifique licorne. Elle avait toujours le sourire et répond merveilleusement aux souhaits des enfants. Avec grand plaisir à nouveau !',
        t2_text:'« Isa a maquillé pour nous à Pâques et les enfants étaient émerveillés ! La licorne arc-en-ciel était magnifique, et le petit a eu un dragon qu\'il montrait fièrement. Nous la réserverons sans hésiter pour la prochaine fête !',
        t3_text:'« Isa a maquillé pour le troisième anniversaire de ma fille. Avec ses jolis motifs, elle fait sourire chaque enfant. Elle est en outre très douce avec les enfants, très sympathique et toujours dévouée et de bonne humeur. Je la recommande chaleureusement.',
        t4_text:'« J\'ai été très séduite par le travail d\'Isa lors de mon enterrement de vie de jeune fille. Son magnifique maquillage a rendu la fête vraiment spéciale. La communication était si bonne que je lui ai spontanément confié plus de responsabilité créative. Absolument recommandé !',
        t5_text:'« Isa était très chaleureuse et les enfants étaient ravis. Le maquillage était vraiment beau et a bien tenu. Tout s\'est déroulé simplement et sereinement. Nous la réserverions à tout moment !',
        t6_text:'« Isa a rendu tant d\'enfants heureux à notre fête ! Malgré la forte affluence, elle est restée calme et sereine. Elle a un excellent contact avec les enfants et sait s\'adapter à chacun. Et elle travaille vite — tout le monde a eu son tour.',
      ...
      kinderschminken: {
        ...
        cta_label:'Prêts ?',
        cta_title:'Maquillage enfants pour votre prochain événement',
        cta_text:'Votre date est peut-être encore libre — demande sans engagement, réponse sous 24 h.',
      ...
      hochzeiten: {
        ...
        mb1_text:'L\'équipement complet, les couleurs professionnelles véganes et les conseils personnalisés sont compris dans le prix. Pour les grands mariages, un renfort peut être organisé sur demande.',
        mb2_title:'Rencontre gratuite',
        mb2_text:'Vous n\'arrivez pas encore à vous le représenter ? Aucun problème. Contactez-moi et je vous montrerai toutes les possibilités. Vous pouvez aussi convenir d\'un rendez-vous sans engagement pour une rencontre et un essai gratuits. Au plaisir de vous rencontrer !',
        faq_label:'Questions fréquentes',
        faq_title:'Face art à votre mariage — vos questions',
        cta_label:'Prêts ?',
        cta_title:'Face art pour votre mariage',
        cta_text:'Votre date est peut-être encore libre — demande sans engagement.',
        cta_btn:'Demander maintenant',
      ...
      unternehmen: {
        ...
        crosslink_kinderschminken:'Maquillage enfants →'},
      about: {
        cta_label:'Votre prochain événement',
        cta_title:'Créons ensemble quelque chose de spécial',
        cta_text:'J\'attends votre message avec impatience — et plus encore votre événement !',
        cta_btn:'Demander maintenant',
    ...
    it: {
      ...
      index: {
        nl_ph_email:'tua@email.ch',
        form_honeypot:'Si prega di lasciare vuoto questo campo',
        t1_role:'Google Local Guide · Compleanno per bambini',
        t2_role:'Mamma · Evento di Pasqua',
        t3_role:'Mamma · 3° compleanno',
        t4_role:'Sposa · Addio al nubilato',
        t5_role:'Festa di famiglia',
        t6_role:'Organizzatrice · Festa per bambini',
        t1_text:'«Siamo più che entusiasti! Isa è una persona molto calorosa e la nostra piccola era felicissima del bellissimo unicorno. Aveva sempre un sorriso e sa rispondere magnificamente ai desideri dei bambini. Sempre volentieri!',
        t2_text:'«Isa ha truccato per noi a Pasqua e i bambini erano entusiasti! L\'unicorno arcobaleno era bellissimo e il piccolo ha avuto un drago che mostrava con orgoglio. La prenoteremo sicuramente per la prossima festa!',
        t3_text:'«Isa ha truccato per il terzo compleanno di mia figlia. Con i suoi bei motivi fa sorridere ogni bambino. È molto affettuosa con i bambini, simpaticissima e sempre dedita e di ottimo umore. La consiglio caldamente.',
        t4_text:'«Sono rimasta molto colpita dal lavoro di Isa al mio addio al nubilato. Il suo splendido trucco ha reso la festa qualcosa di davvero speciale. La comunicazione è stata così buona che le ho spontaneamente lasciato più libertà creativa. Assolutamente consigliata!',
        t5_text:'«Isa è stata molto calorosa e i bambini erano entusiasti. Il trucco era davvero bello e ha tenuto bene. Tutto si è svolto in modo semplice e rilassato. La prenoteremmo di nuovo in qualsiasi momento!',
        t6_text:'«Isa ha reso felici tantissimi bambini alla nostra festa! Nonostante la grande affluenza è rimasta calma e serena. Ha un ottimo rapporto con i bambini e sa adattarsi a ciascuno. E lavora comunque in fretta — tutti sono stati serviti.',
      ...
      kinderschminken: {
        ...
        cta_label:'Pronti?',
        cta_title:'Truccabimbi per il vostro prossimo evento',
        cta_text:'La vostra data potrebbe essere ancora libera — richiesta senza impegno, risposta entro 24 ore.',
      ...
      hochzeiten: {
        ...
        mb1_text:'Attrezzatura completa, colori professionali vegani e consulenza sui motivi sono inclusi nel prezzo. Per matrimoni più grandi si può organizzare supporto aggiuntivo su richiesta.',
        mb2_title:'Incontro conoscitivo gratuito',
        mb2_text:'Non riuscite ancora a immaginarlo? Nessun problema. Contattatemi e vi mostrerò tutte le possibilità. Potete anche fissare un appuntamento senza impegno per un incontro conoscitivo e una prova gratuiti. Vi aspetto!',
        faq_label:'Domande frequenti',
        faq_title:'Face art al vostro matrimonio — le vostre domande',
        cta_label:'Pronti?',
        cta_title:'Face art per il vostro matrimonio',
        cta_text:'La vostra data potrebbe essere ancora libera — richiesta senza impegno.',
        cta_btn:'Richiedi ora',
      ...
      unternehmen: {
        ...
        crosslink_kinderschminken:'Trucco bimbi →'},
      about: {
        cta_label:'Il vostro prossimo evento',
        cta_title:'Creiamo insieme qualcosa di speciale',
        cta_text:'Attendo con piacere il vostro messaggio — e ancora di più il vostro evento!',
        cta_btn:'Richiedi ora',
