  ...
  const T = {
    en: {
      ...
      kinderschminken: {
        ...
        f1_label:'Every design unique', f1_title:'Professional face painting in Zurich',
        f1_text1:'Every design is created live on the spot — no two faces look alike afterwards.',
        f1_text2:'Whether princess, tiger, butterfly or dragon — Isa paints every design on the spot, in Zurich, Dübendorf and the surrounding area.',
        f2_label:'Flexible & individual', f2_title:'Face painting for birthdays & parties in Zurich',
        f2_text1:'With or without a theme — Isa paints all designs herself and tailors them to your wishes. Face art suits every event.',
        f3_label:'Larger events', f3_title:'Face painting for large groups & events',
        f3_text1:'Planning a larger event? Isa will clarify on request whether extra support makes sense — direct and uncomplicated.',
        f3_text2:'Enquire directly via the contact form or WhatsApp.',
      ...
      about: {
        ...
        hero_subtitle:'With colour, creativity and passion — for birthdays, corporate events and weddings in Zurich.',
        about_eyebrow:'Face Art Zürich', about_title:'My passion is my profession',
        about_text1:'Isa comes to your event — whether in Zurich, Dübendorf or the entire Canton of Zurich.',
        about_text2:'Whether for children or adults — Isa brings colour and creativity directly to you. From birthdays and corporate events to weddings and anniversaries, tailored to theme and season.',
        about_text3:'From passion came a profession — Face Art Zürich is the result.',
      ...
      kontakt: {
        ...
        hero_title:'Write to Isa —', hero_title_em:'Reply within 24h.',
        hero_subtitle:'I look forward to your enquiry — and will usually get back to you within 24 hours.',
        info_label:'Contact options', info_title:'How would you like to reach out?',
    ...
    fr: {
      ...
      kinderschminken: {
        ...
        f1_label:'Chaque motif unique', f1_title:'Maquillage enfants professionnel à Zurich',
        f1_text1:'Chaque motif est créé en direct sur place — aucun visage ne se ressemble après.',
        f1_text2:'Princesse, tigre, papillon ou dragon — Isa peint chaque motif sur place, à Zurich, Dübendorf et toute la région.',
        f2_label:'Flexible & individuel', f2_title:'Maquillage enfants pour anniversaires & fêtes à Zurich',
        f2_text1:'Avec ou sans thème — Isa peint tous les motifs elle-même et s\'adapte à vos souhaits. Le face art convient à chaque événement.',
        f3_label:'Grands événements', f3_title:'Maquillage enfants pour grands groupes & événements',
        f3_text1:'Vous planifiez un grand événement ? Isa clarifie sur demande si un renfort est utile — directement et simplement.',
        f3_text2:'Demandez directement via le formulaire de contact ou WhatsApp.',
        ...
        f4_cta:'Réserver l\'anniversaire',
      ...
      about: {
        ...
        hero_subtitle:'Avec couleur, créativité et passion — pour les anniversaires, événements d\'entreprise et mariages à Zurich.',
        about_eyebrow:'Face Art Zürich', about_title:'Ma passion est mon métier',
        about_text1:'Isa vient à votre événement — que ce soit à Zurich, Dübendorf ou dans tout le Canton de Zurich.',
        about_text2:'Pour les enfants comme pour les adultes — Isa apporte couleur et créativité directement chez vous. D\'anniversaires en fêtes d\'entreprise jusqu\'aux mariages et jubilés, adaptés au thème et à la saison.',
        about_text3:'D\'une passion est né un métier — Face Art Zürich en est le résultat.',
      ...
      kontakt: {
        ...
        hero_title:'Écrivez à Isa —', hero_title_em:'Réponse dans les 24h.',
        hero_subtitle:'Isa attend votre message avec impatience — et répondra en général dans les 24 heures.',
        info_label:'Options de contact', info_title:'Comment souhaitez-vous vous manifester ?',
    ...
    it: {
      ...
      kinderschminken: {
        ...
        f1_label:'Ogni motivo unico', f1_title:'Truccabimbi professionale a Zurigo',
        f1_text1:'Ogni motivo viene creato dal vivo sul posto — non ci sono due visi uguali.',
        f1_text2:'Principessa, tigre, farfalla o drago — Isa dipinge ogni motivo sul posto, a Zurigo, Dübendorf e in tutta la regione.',
        f2_label:'Flessibile & individuale', f2_title:'Truccabimbi per compleanni & feste a Zurigo',
        f2_text1:'Con o senza tema — Isa dipinge tutti i motivi lei stessa e si adatta ai vostri desideri. Il face art si adatta a ogni evento.',
        f3_label:'Grandi eventi', f3_title:'Truccabimbi per grandi gruppi & eventi',
        f3_text1:'State pianificando un grande evento? Isa chiarisce su richiesta se un supporto aggiuntivo è utile — direttamente e semplicemente.',
        f3_text2:'Richiedete direttamente tramite il modulo di contatto o WhatsApp.',
      ...
      about: {
        ...
        hero_subtitle:'Con colore, creatività e passione — per compleanni, eventi aziendali e matrimoni a Zurigo.',
        about_eyebrow:'Face Art Zürich', about_title:'La mia passione è il mio lavoro',
        about_text1:'Isa viene al vostro evento — che sia a Zurigo, Dübendorf o in tutto il Cantone di Zurigo.',
        about_text2:'Per bambini o adulti — Isa porta colore e creatività direttamente da voi. Da compleanni a eventi aziendali fino a matrimoni e anniversari, adattati al tema e alla stagione.',
        about_text3:'Dalla passione è nata una professione — Face Art Zürich è il risultato.',
      ...
      kontakt: {
        ...
        hero_title:'Scrivete ad Isa —', hero_title_em:'Risposta entro 24h.',
        hero_subtitle:'Isa non vede l\'ora del vostro messaggio — e risponde di solito entro 24 ore.',
        info_label:'Opzioni di contatto', info_title:'Come preferite contattarci?',
