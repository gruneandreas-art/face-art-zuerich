  ...
  const T = {
    en: {
      ...
      unternehmen: {
        ...
        f1_text:'Children at the booth create instant attention — and a relaxed atmosphere where real conversations happen. Isa handles the kids\' experience, your team handles the consulting. And together we create an unforgettable experience for young and old.',
        f2_label:'Brand identity', f2_title:'Your brand on every face',
        f2_text1:'Whether mascots, logos or other designs based on your branding. I\'m happy to create exclusive designs for face and body just for you, which I then paint live on site.',
        f2_text2:'And if the children should get creative themselves: I\'m happy to create colouring pages for this, which the children colour in themselves on site and which I then paint live according to their ideas.',
        f2_text3:'We\'d be delighted to put together a no-obligation quote for you.',
        ...
        cta_btn:'Get a no-obligation quote', cta_wa:'Write on WhatsApp',
    ...
    fr: {
      ...
      unternehmen: {
        ...
        f1_text:'Les enfants au stand créent une attention immédiate — et une atmosphère détendue où de vraies conversations se créent. Isa s\'occupe de l\'expérience des enfants, votre équipe s\'occupe du conseil. Et ensemble, nous créons une expérience inoubliable pour petits et grands.',
        f2_label:'Identité de marque', f2_title:'Votre marque sur chaque visage',
        f2_text1:'Qu\'il s\'agisse de mascottes, de logos ou d\'autres motifs inspirés de votre branding. Je crée volontiers pour vous des motifs exclusifs pour le visage et le corps, que je peins ensuite en direct sur place.',
        f2_text2:'Et si les enfants doivent eux-mêmes faire preuve de créativité : je crée volontiers pour cela des coloriages, que les enfants colorient eux-mêmes sur place et que je peins ensuite en direct selon leurs idées.',
        f2_text3:'Nous vous établissons volontiers une offre sans engagement à ce sujet.',
        ...
        cta_btn:'Demander une offre sans engagement', cta_wa:'Écrire sur WhatsApp',
    ...
    it: {
      ...
      unternehmen: {
        ...
        f1_text:'I bambini allo stand creano attenzione immediata — e un\'atmosfera rilassata in cui nascono vere conversazioni. Isa gestisce l\'esperienza dei bambini, il vostro team gestisce la consulenza. E insieme creiamo un\'esperienza indimenticabile per grandi e piccini.',
        f2_label:'Identità di marca', f2_title:'Il vostro brand su ogni viso',
        f2_text1:'Che si tratti di mascotte, loghi o altri motivi ispirati al vostro branding. Creo volentieri per voi motivi esclusivi per viso e corpo, che poi dipingo dal vivo sul posto.',
        f2_text2:'E se anche i bambini vogliono essere creativi: creo volentieri dei disegni da colorare, che i bambini colorano loro stessi sul posto e che poi dipingo dal vivo secondo le loro idee.',
        f2_text3:'Siamo felici di preparare per voi un\'offerta senza impegno.',
        ...
        cta_btn:'Richiedi un\'offerta senza impegno', cta_wa:'Scrivere su WhatsApp',
